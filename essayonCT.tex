...
\pagebreak
 ...
 \begin{thebibliography}{33}
  ...
  \bibitem{ct_wu} Confidential Transasctions write up by G. Maxwell: \url{https://people.xiph.org/~greg/confidential_values.txt}
  \bibitem{chaum_bs} Blind Signatures for Payments, D Chaum : \url{http://www.hit.bme.hu/~buttyan/courses/BMEVIHIM219/2009/Chaum.BlindSigForPayment.1982.PDF}
  \bibitem{chaum_dc} The Dining Cryptographers Problem: Unconditional Sender and Recipient Untraceability, D Chaum \url{http://www.cs.elte.hu/~rfid/dcrypt_chaum.html}
  ...
  \bibitem{borromean} Borromean Ring Signatures, G Maxwell, A Poelstra \url{https://github.com/Blockstream/borromean_paper/}
  \bibitem{pbtc} pybitcointools python bitcoin library, V Buterin \url{https://github.com/vbuterin/pybitcointools}
  \bibitem{rfc6979} Deterministic usage of the Digital Signature Algorithm: \url{https://tools.ietf.org/html/rfc6979}
  ...
  \bibitem{pedersen} Original description of the concept behind Pedersen commitments - Non-Interactive and Information-Theoretic Secure Verifiable Secret Sharing, T Pedersen \url{http://link.springer.com/chapter/10.1007%2F3-540-46766-1_9}
  \bibitem{borring} An implementation of Borromean ring signatures in Python, for learning, A Gibson \url{https://github.com/AdamISZ/borring}
  \end{thebibliography}
